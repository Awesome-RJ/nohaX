...
from noha import BOT_USERNAME, OWNER_ID
from noha.noha.config import get_str_key
from noha.functions.pluginhelpers import convert_seconds_to_minutes as time_convert
from noha.functions.pluginhelpers import fetch
from noha import arq, pgram
...
async def alive_function(answers):
    ...
    msg = f"""
**[noha](https://github.com/flashokiller/NoHa):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Awesome_noha)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
