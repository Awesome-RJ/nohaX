...
from noha import StartTime, dispatcher
from noha.modules.helper_funcs.chat_status import sudo_plus
...
def ping(update: Update, context: CallbackContext):
    ...
    start_time = time.time()
    message = msg.reply_text("Pinging... Wait for decades till this end")
    end_time = time.time()
