...
from noha.modules import ALL_MODULES
from noha.modules.helper_funcs.chat_status import is_user_admin
from noha.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"noha.modules.{module_name}")
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text="☠️ Raven Network",
                                url="https://t.me/raven_network",
                            ),
                        ],
                    ],
                ),
